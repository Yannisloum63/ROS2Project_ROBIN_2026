...
See [http://oreilly.com/catalog/errata.csp?isbn=9781449323899](http://oreilly.com/catalog/errata.csp?isbn=9781449323899) for release details.
...
- 6. Robots and Simulators.
   ...
   - 7. Wander-bot.
      ...
      - Summary
   - 8. Teleop-bot. Part II. Moving Around Using ROS
      - Development Pattern
      - Keyboard Driver
      - Motion Generator
      - Parameter Server
...
- 11. Chess-bot.
   ...
   - Summary
- 12. Follow-bot. Part III. Perception and Behavior
   - Acquiring Images
   - Detecting the Line
   - Following the Line
   - Summary
...
- 14. Stockroom-bot.
   ...
   - Picking Up the Item
   - Summary
- 15. Your Own Sensors and Actuators. Part IV. Bringing Your Own Stuff into ROS
...
- 19. Adding a Software Library.
   - Make Your Robot Talk: pyttsx
      ...
      - Checking That Everything Works as Expected
   - Summary
- 20. Tools. Part V. Tips and Tricks
...
ready to answer your questions on [http://answers.ros.org.](http://answers.ros.org.) Why not just learn ROS
...
information. You can access this page at [http://bit.ly/prog_robots_w_ros.](http://bit.ly/prog_robots_w_ros.)
...
Ubuntu Linux can be downloaded freely from [http://ubuntu.com.](http://ubuntu.com.) The remainder of
...
[http://](http://) _hostname_ :11311/, which in this case would imply that there is a running

```
roscore | 11
```

instance of roscore accessible on port 11311 somewhere on a host called _hostname_
...
_<!-- One maintainer tag required, multiple allowed, one person per tag -->
<!-- Example: -->
<!-- <maintainer email="jane.doe@example.com">Jane Doe</maintainer> -->_
**<maintainer** email="user@todo.todo" **>** user **</maintainer>**

_<!-- One license tag required, multiple allowed, one license per tag -->
<!-- Commonly used license strings: -->
<!-- BSD, MIT, Boost Software License, GPLv2, GPLv3, LGPLv2.1, LGPLv3 -->_
**<license>** TODO **</license>**

_<!-- Url tags are optional, but multiple are allowed, one per tag -->
<!-- Optional attribute type can be: website, bugtracker, or repository -->
<!-- Example: -->
<!-- <url type="website">http://wiki.ros.org/my_awesome_code</url> -->_

_<!-- Author tags are optional, multiple are allowed, one per tag -->
<!-- Authors do not have to be maintainers, but could be -->_
...
_<!-- Example: -->
<!-- <author email="jane.doe@example.com">Jane Doe</author> -->_

_<!-- The *_depend tags are used to specify dependencies -->
...
<!-- <test_depend>gtest</test_depend> -->_
**<buildtool_depend>** catkin **</buildtool_depend>
<build_depend>** rospy **</build_depend>
<run_depend>** rospy **</run_depend>**

_<!-- The export tag contains other, unspecified, tags -->_
**<export>**
_<!-- Other tools can request additional information be placed here -->_
...
_<package name>.msg_ , since this is where the package definitions are stored (more on
...
```
```
uint8 Unsigned 8-bit integer uint8_t int uint8[] is treated as a string in
Python
```
```
...
```
```
string ASCII string std::string string ROS does not support Unicode strings;
...
```
Defining Your Own Message Types | 41
```
...
_"""autogenerated by genpy from basics/Complex.msg. Do not edit."""_
**import sys**
...
_has_header = False _#flag to mark the presence of a Header object_
...
changes. You cannot mix in-order arguments and keyword arguments._

```
Defining Your Own Message Types | 43
```

_The available fields are:
real,imaginary_

_:param args: complete set of field values, in .msg order
:param kwds: use keyword arguments corresponding to message field names
to set specific fields.
"""_
**if** args **or** kwds:
super(Complex, self).__init__(*args, **kwds)
_#message fields cannot be None, assign default values for those that are_
...
```
Defining Your Own Message Types | 45
```
...
_"""autogenerated by genpy from basics/WordCountRequest.msg. Do not edit."""_
**import sys**
python3 = True **if** sys.hexversion > 0x03000000 **else** False
**import genpy
import struct**
...
_:param args: complete set of field values, in .msg order
:param kwds: use keyword arguments corresponding to message field names_

```
Defining a Service | 53
```

_to set specific fields.
"""_
**if** args **or** kwds:
...
_# This is an action definition file, which has three parts: the goal, the
# result, and the feedback.
#
# Part 1: the goal, to be sent by the client
#
# The amount of time we want to wait_
duration time_to_wait
---
_# Part 2: the result, to be sent by the server upon completion
#
# How much time we waited_
duration time_elapsed
_# How many updates we provided along the way_

**62 | Chapter 5: Actions**


uint32 updates_sent
---
_# Part 3: the feedback, to be sent periodically by the server during
# execution.
#
# The amount of time that has elapsed from the start_
duration time_elapsed
_# The amount of time remaining until we're done_
...
```
```
Implementing a Basic Action Server | 65
```
...
```
Implementing a More Sophisticated Action Server | 69
```
...
goal = TimerGoal()
goal.time_to_wait = rospy.Duration.from_sec(5.0)
_# Uncomment this line to test server-side abort:
#goal.time_to_wait = rospy.Duration.from_sec(500.0)_
client.send_goal(goal, feedback_cb=feedback_cb)

_# Uncomment these lines to test goal preemption:
#time.sleep(3.0)
#client.cancel_goal()_
...
```
```
Using the More Sophisticated Action | 73
```
...
```
```
Action Most request/response interactions, especially when servicing the request is not instantaneous (e.g., navigating to a
goal location)
```
...
**78 | Chapter 6: Robots and Simulators**
...
**80 | Chapter 6: Robots and Simulators**
...
**82 | Chapter 6: Robots and Simulators**
...
**84 | Chapter 6: Robots and Simulators**
...
**86 | Chapter 6: Robots and Simulators**
...
**88 | Chapter 6: Robots and Simulators**
...
available at [http://robonaut.jsc.nasa.gov.](http://robonaut.jsc.nasa.gov.)

**90 | Chapter 6: Robots and Simulators**
...
[http://turtlebot.org.](http://turtlebot.org.)
...
**92 | Chapter 6: Robots and Simulators**
...
**94 | Chapter 6: Robots and Simulators**
...
**96 | Chapter 6: Robots and Simulators**
...
g_range_ahead = 1 _# anything to start_

**106 | Chapter 7: Wander-bot**
...
**else** : _# we're not driving_forward_
**if** rospy.Time.now() > state_change_time:
driving_forward = True _# we're done spinning, time to go forward!_
...
```
Sensing and Actuation: Wander-bot! | 107
```
...
In this chapter, we first created an open-loop control system in
...
rospy.Subscriber('keys', String, keys_cb, twist_pub)
rate = rospy.Rate(10)
g_last_twist = Twist() _# initializes to zero_
**while not** rospy.is_shutdown():
twist_pub.publish(g_last_twist)
rate.sleep()
...
's': [ 0, 0] }
g_last_twist = None
g_vel_scales = [0.1, 0.1] _# default to very slow_
...
g_vel_scales = [0.1, 0.1] _# default to very slow_
g_vel_ramps = [1, 1] _# units: meters per second^2_

**def** ramped_vel(v_prev, v_target, t_prev, t_now, ramp_rate):
_# compute maximum velocity step_
step = ramp_rate * (t_now - t_prev).to_sec()
sign = 1.0 **if** (v_target > v_prev) **else** -1.0
error = math.fabs(v_target - v_prev)
**if** error < step: _# we can get there within this timestep-we're done._
**return** v_target
**else** :
**return** v_prev + sign * step _# take a step toward the target_
...
g_target_twist = Twist() _# initializes to zero_
g_last_twist = Twist()
...
**136 | Chapter 9: Building Maps of the World**
...
**138 | Chapter 9: Building Maps of the World**
...
```
```
Recording Data with rosbag | 139
```
...
**140 | Chapter 9: Building Maps of the World**
...
```
**142 | Chapter 9: Building Maps of the World**
...
what it is by adding _scan:=laser_scan_topic_ when you start the node. The mapper
...
**144 | Chapter 9: Building Maps of the World**
...
```
**146 | Chapter 9: Building Maps of the World**
...
**148 | Chapter 9: Building Maps of the World**
...
```
Starting a Map Server and Looking at a Map | 149
```
...
**150 | Chapter 9: Building Maps of the World**
...
model_odometry, beam_range_finder_model, likelihood_field_range_finder_
...
**152 | Chapter 10: Navigating About the World**
...
```
Localizing the Robot in a Map | 153
```
...
**154 | Chapter 10: Navigating About the World**
...
```
Localizing the Robot in a Map | 155
```
...
**156 | Chapter 10: Navigating About the World**
...
```
Using the ROS Navigation Stack | 157
```
...
**158 | Chapter 10: Navigating About the World**
...
```
Using the ROS Navigation Stack | 159
```
...
**160 | Chapter 10: Navigating About the World**
...
**162 | Chapter 10: Navigating About the World**
...
```
Joints, Links, and Kinematic Chains | 167
```
...
```
Joints, Links, and Kinematic Chains | 169
```
...
```
Installing and Running a Simulated R2 | 173
```
...
_# now, wave arms around randomly_
**while not** rospy.is_shutdown():
...
argv = rospy.myargv(argv=sys.argv) _# filter out any arguments used by ROS_
**if** len(argv) != 8:
...
**if** state == "pre-pinch":
vec = [ 0.3, 0, 1.57, 0, _# index_
-0.1, 0, 1.57, 0, _# middle_
0, 0, 0, _# ring_
0, 0, 0, _# pinkie_
0, 1.1, 0, 0] _# thumb_
**elif** state == "pinch":
...
```
Playing Back a Famous Chess Game | 187
```
...
```
```
Defining State Machines with smach | 215
```
...
```
```
Defining State Machines with smach | 217
```
...
```
Defining State Machines with smach | 219
```

_# Add all the turns_
**for** i **in** xrange(sides - 1):
StateMachine.add('TURN_{0}'.format(i + 1),
Turn(360.0 / sides),
transitions={'success':'SIDE_{0}'.format(i + 2)})

_# Add the final side_
...
```
Patrolling with State Machines | 223
```
...
_#os.system("rosservice call clear_octomap")_

gripper_goal.command.position = 0
gripper.send_goal(gripper_goal)

```
Picking Up the Item | 249
```
...
**260 | Chapter 15: Your Own Sensors and Actuators**
...
z: 0.0
```
**262 | Chapter 15: Your Own Sensors and Actuators**
...
**264 | Chapter 15: Your Own Sensors and Actuators**
...
**266 | Chapter 15: Your Own Sensors and Actuators**
...
**268 | Chapter 15: Your Own Sensors and Actuators**
...
**270 | Chapter 15: Your Own Sensors and Actuators**
...
**272 | Chapter 15: Your Own Sensors and Actuators**
...
**274 | Chapter 15: Your Own Sensors and Actuators**
...
**276 | Chapter 16: Your Own Mobile Robot**
...
```
**278 | Chapter 16: Your Own Mobile Robot**
...
**280 | Chapter 16: Your Own Mobile Robot**
...
**282 | Chapter 16: Your Own Mobile Robot**
...
**284 | Chapter 16: Your Own Mobile Robot**
...
**286 | Chapter 16: Your Own Mobile Robot**
...
**288 | Chapter 16: Your Own Mobile Robot**
...
**290 | Chapter 16: Your Own Mobile Robot**
...
**<launch>**
_<!-- Load the TortoiseBot URDF model into the parameter server -->_
**<param** name="robot_description" textfile="$(find tortoisebot)/tortoisebot.urdf" **/>**
_<!-- Start Gazebo with an empty world -->_
**<include** file="$(find gazebo_ros)/launch/empty_world.launch" **/>**
_<!-- Spawn a TortoiseBot in Gazebo, taking the description from the
parameter server -->_
...
**292 | Chapter 16: Your Own Mobile Robot**
...
**294 | Chapter 16: Your Own Mobile Robot**
...
**296 | Chapter 16: Your Own Mobile Robot**
...
**300 | Chapter 17: Your Own Mobile Robot: Part 2**
...
```
**302 | Chapter 17: Your Own Mobile Robot: Part 2**
...
**304 | Chapter 17: Your Own Mobile Robot: Part 2**
...
**306 | Chapter 17: Your Own Mobile Robot: Part 2**
...
```
**308 | Chapter 17: Your Own Mobile Robot: Part 2**
...
```
Configuring the Navigation Stack | 309
```
...
**310 | Chapter 17: Your Own Mobile Robot: Part 2**
...
```
Configuring the Navigation Stack | 311
```
...
**312 | Chapter 17: Your Own Mobile Robot: Part 2**
...
**314 | Chapter 17: Your Own Mobile Robot: Part 2**
...
```
Using rviz to Localize and Command a Navigating Robot | 315
```
...
**316 | Chapter 17: Your Own Mobile Robot: Part 2**
...
**320 | Chapter 18: Your Own Robot Arm**
...
**322 | Chapter 18: Your Own Robot Arm**
...
**324 | Chapter 18: Your Own Robot Arm**
...
**326 | Chapter 18: Your Own Robot Arm**
...
**328 | Chapter 18: Your Own Robot Arm**
...
**<launch>**
_<!-- Load the CougarBot URDF model into the parameter server -->_
**<param** name="robot_description" textfile="$(find cougarbot)/cougarbot.urdf" **/>**
_<!-- Start Gazebo with an empty world -->_
**<include** file="$(find gazebo_ros)/launch/empty_world.launch" **/>**
_<!-- Spawn a CougarBot in Gazebo, taking the description from the
parameter server -->_
**<node** name="spawn_urdf" pkg="gazebo_ros" type="spawn_model"
...
**330 | Chapter 18: Your Own Robot Arm**
...
```
**332 | Chapter 18: Your Own Robot Arm**
...
**334 | Chapter 18: Your Own Robot Arm**
...
**336 | Chapter 18: Your Own Robot Arm**
...
**338 | Chapter 18: Your Own Robot Arm**
...
**340 | Chapter 18: Your Own Robot Arm**
...
**342 | Chapter 18: Your Own Robot Arm**
...
**344 | Chapter 18: Your Own Robot Arm**
...
**346 | Chapter 18: Your Own Robot Arm**
...
**348 | Chapter 19: Adding a Software Library**
...
```
Make Your Robot Talk: pyttsx | 349
```
...
**350 | Chapter 19: Adding a Software Library**
...
```
Make Your Robot Talk: pyttsx | 351
```
...
from basics.msg import TalkAction, TalkGoal, TalkResult
```
**352 | Chapter 19: Adding a Software Library**
...
```
Make Your Robot Talk: pyttsx | 353
```
...
```
**354 | Chapter 19: Adding a Software Library**
...
[http://localhost:61515.](http://localhost:61515.) The port on which a node listens (61515 in this example) is
...
```
Starting Many Nodes: roslaunch | 365
```
...
```
Testing a Many-Node System: rostest | 367
```
...
```
Introspection: rosnode, rostopic, rosmsg, rosservice, and rossrv | 371
```
...
**376 | Chapter 21: Debugging Robot Behavior**
...
```
Log Messages: /rosout and rqt_console | 377
```
...
**378 | Chapter 21: Debugging Robot Behavior**
...
```
Log Messages: /rosout and rqt_console | 379
```
...
**380 | Chapter 21: Debugging Robot Behavior**
...
```
Log Messages: /rosout and rqt_console | 381
```
...
**382 | Chapter 21: Debugging Robot Behavior**
...
**384 | Chapter 21: Debugging Robot Behavior**
...
```
Nodes, Topics, and Connections: rqt_graph and rosnode | 385
```
...
**386 | Chapter 21: Debugging Robot Behavior**
...
```
```
Nodes, Topics, and Connections: rqt_graph and rosnode | 387
```
...
'std_msgs/String'}
```
**388 | Chapter 21: Debugging Robot Behavior**
...
```
```
Nodes, Topics, and Connections: rqt_graph and rosnode | 389
```
...
**390 | Chapter 21: Debugging Robot Behavior**
...
**392 | Chapter 21: Debugging Robot Behavior**
...
**394 | Chapter 21: Debugging Robot Behavior**
...
```
```
Data Logging and Analysis: rosbag and rqt_bag | 395
```
...
**396 | Chapter 21: Debugging Robot Behavior**
...
```
Data Logging and Analysis: rosbag and rqt_bag | 397
```
...
**398 | Chapter 21: Debugging Robot Behavior**
...
The backbone of the wiki is a set of package pages, each named [http://wiki.ros.org/](http://wiki.ros.org/)

<package name>. For example, to find documentation on the rospy package, you

would go to [http://wiki.ros.org/rospy?distro=indigo.](http://wiki.ros.org/rospy?distro=indigo.) The package pages follow a con‐
...
**400 | Chapter 22: The ROS Community: Online Resources**
...
**402 | Chapter 22: The ROS Community: Online Resources**
...
information can be found at [http://lists.ros.org/mailman/listinfo/ros-users.](http://lists.ros.org/mailman/listinfo/ros-users.) The ros-
...
**404 | Chapter 22: The ROS Community: Online Resources**
...
```
Translating from Python to C++ (and Back Again) | 409
```
...
```
Translating from Python to C++ (and Back Again) | 411
```
...
argument for a callback dealing with messages of type _T_ should have an argument of

type const _T_ ::ConstPtr &. When building the message definition, catkin will make
...
```
Translating from Python to C++ (and Back Again) | 413
```
